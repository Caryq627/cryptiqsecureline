...
(function (root) {
  ...
  const cqIcons = {
    ...
    // iOS-style share: up-arrow piercing out of an open-top tray. Reads as
    // "send/upload/share" more directly than the three-node graph at icon size.
    share:      svg('<path d="M12 4v12"/><path d="m8 8 4-4 4 4"/><path d="M5 13v5a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-5"/>'),
